...
function generateDailyConceptQuestions(){
  ...
  targets.forEach(target => {
    ...
    try {
      ...
      const activeUnitsForTarget = (data.conceptCurriculumUnits || []).filter(u => u.active && JSON.stringify(u.target) === targetKey);
      const newItems = generateConceptQuestionsForTarget_(target, existing, activeUnitsForTarget);
...
function generateConceptQuestionsForTarget_(target, existingItems, activeUnitsForTarget){
